...
% Jakob Heide J�rgensen, Maria Saxild-Hansen and Per Chr. Hansen,
...
% xp = [-N2*ones(p2,1); rand(p2,1).*linspace(-N2+Np1,N2-Np1,p1)'];
% yp = [rand(p2,1)+linspace(-N2+Np2,N2-Np2,p2)'; N2*ones(p1,1)];
